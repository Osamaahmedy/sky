...
if (isset($_POST['submit'])) {
    ...
    $number = mysqli_real_escape_string($conn, $_POST['phonNumber']);
    $destination = mysqli_real_escape_string($conn, $_POST['destination']);
    $email = mysqli_real_escape_string($conn, $_POST['email']);
    $datetime = mysqli_real_escape_string($conn, $_POST['datetime']);
    if (empty($name) || empty($number) || empty($destination) || empty($datetime) || empty($email)) {
        $message['form1'][] = '<p>Please fill in all the required inputs!</p>';
    } 
    else{
    // Check if account already exists in the database
    $checkQuery = "SELECT * FROM `skylanddb` WHERE name = '$name' AND phonNumber = '$number'";
    $checkResult = mysqli_query($conn, $checkQuery);
    if (mysqli_num_rows($checkResult) > 0) {
        // Account already exists in the database
        $message['form1'][] = 'Account already exists in the database!';
    } else {
        // Insert the new account into the database
        $insertQuery = "INSERT INTO `skylanddb` (name, phonNumber, destination,email,  date) VALUES ('$name', '$number', '$destination','$email',  '$datetime')";
...
if (isset($_POST['submitem'])) {
    ...
    // Check if account already exists in the database
    if (empty($email)  ) {
        $message['form2'][] = '<p>Please fill in all the required inputs!</p>';
    } 
    else{
        $checkQuery = "SELECT * FROM `skylanddb_email` WHERE email = '$email'";
        $checkResult = mysqli_query($conn, $checkQuery);
        if (mysqli_num_rows($checkResult) > 0) {
            // Account already exists in the database
            $message['form2'][] = 'email already exists in the database!';
        } else {
    
        // Insert the new account into the database
        $insertQuery = "INSERT INTO `skylanddb_email` (email) VALUES ('$email')";
        $insert = mysqli_query($conn, $insertQuery) or die('Query failed');
        if ($insert) {
            $message['form2'][] = 'email have been added!';
        } else {
            $message['form2'][] = 'Appointment failed';
        }
    }
  }
}
...
<head>
    ...
    <title>Sky land - Travel agancy</title>
...
<style>
    ...
    .form1 input:focus{
        ...
        box-shadow: 0px 0px 6px 2px hsl(0deg 0% 100% / 50%);
    }
    *{
    ...
    align-items: center;
    gap: 20px;
    transform: translate(6rem, -180px);
    width: 15rem;
  ...
  -->
        ...
        <div class="header-top">
            <div class="container">
                ...
                <a href="tel:+01123456790" class="helpline-box">
                    ...
                    <div class="wrapper">
                        <p class="helpline-title">For urgent order :</p>

                        <p class="helpline-number">+967 718 323 599</p>
                    </div>
        ...
        <div class="header-bottom">
            <div class="container">
              ...
              <ion-icon name="close-outline"></ion-icon>
                ...
                <a class="btn btn-primary" href="#tour-search">Boy now</a>
    ...
    <main>
      ...
      -->
            ...
            <section class="hero" id="home">
                ...
                <div class="container">
                    ...
                    <h2 class="h1 hero-title"><span >Sky land</span> will take you where you want </h2>

                    <p class="hero-text">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iste minus aut suscipit ipsum, debitis harum minima dolorem asperiores, exercitationem ullam consectetur illo dolore repellendus eius explicabo praesentium modi corporis velit?
                    </p>

                    <div class="btn-group">
                        <button class="btn btn-primary">Learn more</button>

                        <a class="btn btn-secondary" href="#tour-search">Boy now</a>
                    </div>
      ...
      -->
        ...
        <input type="number" name="phonNumber" require placeholder="phonNumber" >
        
        <input type="text" name="destination" require placeholder="destination" >
       
        <input type="email" name="email" id="" placeholder="email" value="@"> 
       
        <input type="date" name="datetime" id="" placeholder="date" >
        
        <input style="background-color: hsl(0deg 0% 100% / 83%);" type="submit" name="submit" value="save">
            ...
            <section class="gallery" id="gallery">
                <div class="container">
                    ...
                    <ul class="gallery-list">
                        ...
                        <li class="gallery-item">
                            <figure class="gallery-image">
                                <img src="assets/images/1715278802806.jpg" alt="Gallery image">
                            </figure>
                        </li>
            ...
            <div class="container">
                ...
                <div class="footer-brand">
                    ...
                    <a href="#" class="logo">
                      ...
                      font-size: 25px;
                      font-family: cursive;
                      font-weight: bold;" href="#" class="logo">
                            Sky land
                        </h1>
                    </a>
                ...
                <div class="footer-contact">
                    ...
                    <ul>
                        ...
                        <li class="contact-item">
                            ...
                            <a href="tel:+01123456790" class="contact-link">+967 718 323 599</a>
                        </li>

                        <li class="contact-item">
                            <ion-icon name="mail-outline"></ion-icon>

                            <a href="mailto:info.tourly.com" class="contact-link">info.Skyland.com</a>
                        </li>

                        <li class="contact-item">
                            <ion-icon name="location-outline"></ion-icon>

                            <address>YEMEN,ADEN-Crater</address>
                        </li>
...
<?php
    ...
    <input style="text-align: center;" type="submit" name="submitem" value="save">
</form>
